...
class Campaign(Base):
    ...
    privacy_policy_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("privacy_policies.id", ondelete="SET NULL"), nullable=True)
    title: Mapped[str] = mapped_column(String(500), nullable=False)
    petition_title: Mapped[str | None] = mapped_column(String(500))
